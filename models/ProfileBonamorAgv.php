...
/**
 * This is the model class for table "profile_bonamor_agv".
 *
 * The followings are the available columns in table 'profile_bonamor_agv':
 * @property integer $id
 ...
 */
class ProfileBonamorAgv extends UTIActiveRecord
{
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ProfileBonamorAvg the static model class
     */
