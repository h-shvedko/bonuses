...
/**
 * This is the model class for table "profile_periode_binar".
 *
 * The followings are the available columns in table 'profile_periode_binar':
 * @property integer $id
 ...
 */
class ProfilePeriodeBinar extends UTIActiveRecord
{
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ProfilePeriodeBinar the static model class
     */
    ...
    public function relations()
    {
        ...
        return array(
            'binar' => array(self::HAS_MANY, 'ProfileBonuses', 'periode__id'),
