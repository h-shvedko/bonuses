...
/**
 * This is the model class for table "profile_house_bonuses".
 *
 * The followings are the available columns in table 'profile_house_bonuses':
 * @property integer $id
 ...
 */
class ProfileHouseBonuses extends UTIActiveRecord
{
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ProfileHouseBonuses the static model class
     */
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id, users__id, amount, amount_from, persents, rank,periode_date, created_at, created_by, created_ip, modified_at, modified_by, modified_ip', 'safe', 'on'=>'search'),
        );
    }
