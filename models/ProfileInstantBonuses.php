...
/**
 * This is the model class for table "profile_instant_bonuses".
 *
 * The followings are the available columns in table 'profile_instant_bonuses':
 * @property integer $id
 ...
 */
class ProfileInstantBonuses extends UTIActiveRecord
{
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ProfileInstantBonuses the static model class
     */
    ...
    {
        return 'profile_instant_bonuses';
    }
    ...
    public function rules()
    {
        ...
        return array(
            array('users__id, users__id__from, transactions__id, created_by, modified_by, periode__id', 'numerical', 'integerOnly'=>true),
            array('amount_from, amount', 'length', 'max'=>10),
            array('created_ip, modified_ip', 'length', 'max'=>255),
            array('periode_date, created_at, modified_at', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, users__id, users__id__from, transactions__id, amount_from, amount, periode_date, created_at, created_by, created_ip, modified_at, modified_by, modified_ip', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'transaction' => array(self::BELONGS_TO, 'FinanceTransactions', 'transactions__id'),
