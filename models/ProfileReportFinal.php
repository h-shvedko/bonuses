 ...
 */
class ProfileReportFinal extends UTIActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('users__id, users__id__from, bonuses__id, sponsor__id, level, created_by, modified_by, transactions__id, periode__id, kvalify_user, count_first_line', 'numerical', 'integerOnly'=>true),
            ...
            array('id, users__id, users__id__from, alias, alias__from, director_alias, amount, amount_from, periode_date, bonuses__id, sponsor__id, level, persents, created_at, created_by, created_ip, modified_at, modified_by, modified_ip, transactions__id, periode__id, kvalify_user, count_first_line, pv', 'safe', 'on'=>'search'),
        );
    }
