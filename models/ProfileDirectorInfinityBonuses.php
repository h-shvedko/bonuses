...
/**
 * This is the model class for table "profile_director_infinity_bonuses".
 *
 * The followings are the available columns in table 'profile_director_infinity_bonuses':
 * @property integer $id
 ...
 */
class ProfileDirectorInfinityBonuses extends UTIActiveRecord
{
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ProfileDirectorInfinityBonuses the static model class
     */
    ...
    {
        return 'profile_director_infinity_bonuses';
    }
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id, users__id, persents, amount, periode_date, created_at, created_by, created_ip, modified_at, modified_by, modified_ip', 'safe', 'on'=>'search'),
        );
    }
