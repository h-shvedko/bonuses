 ...
 * @property integer $id
 * @property integer $profile_bonamor_structure_settings__id
 ...
 */
class ProfileBonamorStructureSettingsHistory extends UTIActiveRecord
{
	...
	{
		return 'profile_bonamor_structure_settings_history';
	}
	...
	public function rules()
	{
		...
		return array(
			array('profile_bonamor_structure_settings__id, user__id, referal_register_type, profile_bonamor__contract_no, register_leg, register_filltype, created_by, modified_by', 'numerical', 'integerOnly'=>true),
			array('created_ip, modified_ip', 'length', 'max'=>100),
			array('created_at, modified_at', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, profile_bonamor_structure_settings__id, user__id, referal_register_type, profile_bonamor__contract_no, register_leg, register_filltype, created_at, created_by, created_ip, modified_at, modified_by, modified_ip', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'settings'              => array(self::BELONGS_TO, 'ProfilebonamorStructureSettings', 'profile_bonamor_structure_settings__id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'profile_bonamor_structure_settings__id' => 'Profile bonamor Structure Settings',
			'user__id' => 'User',
	...
	public function search()
	{
		...
		$criteria->compare('profile_bonamor_structure_settings__id',$this->profile_bonamor_structure_settings__id);
