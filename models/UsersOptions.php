...
/**
 * This is the model class for table "users_options".
 *
 * The followings are the available columns in table 'users_options':
 * @property integer $id
 ...
 */
class UsersOptions extends UTIActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            'lang' => array(self::HAS_ONE, 'UsersOptionsLang', 'options__id'),
            'profilebonamor' => array(self::HAS_MANY, 'ProfileBonamor', array('options__id' => 'id')),
        );
    }
